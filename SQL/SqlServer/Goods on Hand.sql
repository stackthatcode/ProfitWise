...
FROM profitwisemastervariant t1
	...
	INNER JOIN profitwiseproduct t3 
		ON t2.PwProductId = t3.PwProductId AND t1.PwShopId = t2.PwShopId
	INNER JOIN profitwisemastervariantcogscalc t4
